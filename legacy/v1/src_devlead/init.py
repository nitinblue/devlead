...
# Files to copy into devlead_docs/
DOC_FILES = [
    "_project_status.md",
    "_project_roadmap.md",
    "_project_stories.md",
...
GITIGNORE_ENTRY = "devlead_docs/session_state.json"


def do_init(project_dir: Path) -> None:
    """Initialize a DevLead project.

    1. Create devlead_docs/ with template files
    ...
    # 1. Create devlead_docs/ and copy templates
    ...
    print(f"  devlead_docs/ — {len(list(docs_dir.glob('*.md')))} doc files")
