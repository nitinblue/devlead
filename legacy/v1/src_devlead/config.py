...
DEFAULT_CONFIG: dict = {
    ...
    "paths": {
        ...
        "docs_policy": "warn",     # "log", "warn", "block" — devlead_docs writes outside UPDATE
    },
    "governance": {
        "task_required": "warn",      # "log", "warn", "block" — Edit/Write needs IN_PROGRESS task
        "memory_from_docs": "warn",   # "log", "warn", "block" — memory writes only in UPDATE
