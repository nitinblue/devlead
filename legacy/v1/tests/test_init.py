...
def test_init_creates_devlead_docs(tmp_path):
    """init creates devlead_docs/ directory."""
    do_init(tmp_path)
    assert (tmp_path / "devlead_docs").is_dir()
...
def test_init_idempotent(tmp_path):
    ...
    # Files still exist
    assert (tmp_path / "devlead_docs" / "_project_tasks.md").exists()
