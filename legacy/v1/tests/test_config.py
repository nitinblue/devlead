...
def test_default_config_values():
    ...
    assert DEFAULT_CONFIG["project"]["docs_dir"] == "devlead_docs"
...
def test_load_config_no_toml(tmp_path):
    ...
    assert config["project"]["docs_dir"] == "devlead_docs"
...
def test_get_docs_dir(tmp_path):
    ...
    assert docs == tmp_path / "devlead_docs"
...
def test_get_state_file(tmp_path):
    ...
    assert sf == tmp_path / "devlead_docs" / "session_state.json"
